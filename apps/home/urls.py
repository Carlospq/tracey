...
urlpatterns = [
    ...
    path('ajax/update-domaingroups/', views.update_domaingroups, name='ajax_update_domaingroups'),
    path('ajax/update-domaingroups-results/', views.read_update_domaingroups_results, name='ajax_update_domaingroups_results'),
    path('ajax/upload-hmm/', views.upload_hmm_model, name='ajax_upload_hmm'),
